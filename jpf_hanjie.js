...
function swapPuzzle(e) {
      if (confirm("You will lose all of your work on the puzzle, you doofus! Continue?")) {


            // Retrieve the ID on the cliked button.
...
function setBackground(e) {
      ...
      // Set Background based on the keyboard event. 
      if (e.shiftKey) {
